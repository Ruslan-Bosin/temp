...
export default function ClientSignup({navigation}) {
  ...
  const signupPressed = () => {
    fetch(Config.base_url + "/rest/client/signup", {
      method: "POST",
      headers: {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.info}>
        Регистрация аккаунта клиента. Если у вас есть аккаунта вы можете
      </Text>
      <TouchableOpacity onPress={clientLogin}><Text style={styles.infoLink}>войти</Text></TouchableOpacity>

      <Input onChange={(value) => {setName(value)}} type="name" style={styles.input}/>
